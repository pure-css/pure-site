...
exports.sectionHeading = function (heading, options) {
    options = (options && options.hash) || {};
    tagName    = options.tagName && typeof options.tagName === 'string' ? options.tagName : 'h2';
    classnames = options.classnames && typeof options.classnames === 'string' ?
                 options.classnames : 'content-subhead';
    ...
    id = options.id && typeof options.id === 'string' ? options.id : heading.toLowerCase()
                .replace(/&[^\s;]+;?/g, '')
                .replace(/[^\s\w\-]+/g, '')
                .replace(/\s+/g, '-');
